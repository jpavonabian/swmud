...
"import", "r13", "r14", "r15", "r16", "r17", "r18", "r19", "r20", "r21", "r22", "r23",
...
char *	const	w_flags	[] =
{
"tomable", "dedo", "cuello", "cuerpo", "cabeza", "piernas", "pies", "manos", "brazos",
"escudo", "sobre", "cintura", "munyeca", "blandir", "sostener", "_dual_", "orejas", "ojos",
"_missile_", "espalda","holster1","holster2","esposas","r23","r24",
...
char *	const	o_types2	[] =
{
"ninguno", "luz", "pergamino", "varita", "baston", "arma", "armafuego", "misil",
"tesoro", "armadura", "poción", "_worn", "mueble", "basura", "_oldtrap",
"contenedor", "_note", "contenedorbebida", "llave", "comida", "moneda", "lápiz", "bote",
"cuerpo", "cuerpo_pc", "fuente", "pastilla", "sangre", "fuentesangre",
"restos", "_pipe", "_herbcon", "_herb", "_incense", "fuego", "libro", "interruptor",
"palanca", "_pullchain", "botón", "dial", "_runa", "_runepouch", "_match", "trampa",
"mapa", "_portal", "papel", "_tinder", "lockpick", "_spike", "_disease", "_oil",
"combustible", "targetacredito", "_longbow", "_crossbow", "municion", "_quiver", "pala",
"balsamo", "rawspice", "lente", "cristal", "duraplastico", "batería", 
"herramientas", "duracero", "horno", "espejo", "circuito", "superconductor", "enlace", "medpac",
"tela", "metal_raro", "magnetico",  "hilo", "spice", "smut", "dispositivo", "spacecraft",
"granada", "mina", "gobierno", "cuerpo_dr", "tornillo", "quimico", "comunicador",
"datapad", "modulo", "bug", "localizador", "grenadelauncher", "missilelauncher",
"binders", "gafas", "shipbomb", "empgrenade"
};
...
"nosummon", "pageron", "notitled", "room", "r12", "r13",
