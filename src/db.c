...
void boot_db( bool fCopyOver )
{
   ...
   if( !sysdata.dlHandle )
   {
	...
	ASSIGN_GSN( gsn_eliteguard , "elite_guard" );
        ...
        ASSIGN_GSN( gsn_gather_intelligence , "informes" );
        ASSIGN_GSN( gsn_specialforces , "special_forces" );
        ASSIGN_GSN( gsn_jail , "encarcelar" );
        ASSIGN_GSN( gsn_smalltalk , "discursito" );
        ...
        ASSIGN_GSN( gsn_masspropeganda , "grandiscurso" );
        ASSIGN_GSN( gsn_beg  , "rogar" );
        ASSIGN_GSN( gsn_hijack  , "secuestrar" );
        ASSIGN_GSN( gsn_makejewelry  , "fabricarjoya" );
        ASSIGN_GSN( gsn_makeblade  , "fabricarhoja" );
        ASSIGN_GSN( gsn_sabotage  , "sabotear" );
        ASSIGN_GSN( gsn_makeblaster  , "fabricararmalaser" );
        ASSIGN_GSN( gsn_makelight   , "fabricarlinterna" );
        ASSIGN_GSN( gsn_makecomlink   , "fabricarenlacedecomunicaciones" );
        ASSIGN_GSN( gsn_makegrenade   , "fabricargranada" );
        ASSIGN_GSN( gsn_makeshipbomb  , "fabricarbomba" );
        ASSIGN_GSN( gsn_makelandmine  , "fabricarmina" );
        ASSIGN_GSN( gsn_makearmor  , "fabricararmadura" );        
        ASSIGN_GSN( gsn_makepike  , "fabricarpica" );
        ASSIGN_GSN( gsn_makeshield  , "fabricarescudo" );
        ASSIGN_GSN( gsn_makecontainer  , "fabricarcontenedor" );
        ASSIGN_GSN( gsn_makemissile  , "makemissile" );        
        ASSIGN_GSN( gsn_gemcutting  , "gemcutting" );        
        ASSIGN_GSN( gsn_battle_command  , "tomar_el_mando" );
        ASSIGN_GSN( gsn_reinforcements  , "reinforcements" );
        ASSIGN_GSN( gsn_postguard   , "post guard" );
	ASSIGN_GSN( gsn_smallspace, "naves pequenyas");
	ASSIGN_GSN( gsn_mediumspace, "naves medias");
	ASSIGN_GSN( gsn_largespace, "naves capitales");
	ASSIGN_GSN( gsn_largespace, "naves capitales");
        ASSIGN_GSN( gsn_torture   , "torturar" );
        ASSIGN_GSN( gsn_throw   , "lanzar" );
        ASSIGN_GSN( gsn_snipe   , "disparar" );
        ASSIGN_GSN( gsn_deception  , "enganyar" );
        ASSIGN_GSN( gsn_disguise   , "disfrazarse" );
        ASSIGN_GSN( gsn_mine   , "minar" );
        ASSIGN_GSN( gsn_plantbug   , "plantarbicho" );
        ASSIGN_GSN( gsn_showbugs  , "verbichos" );
	ASSIGN_GSN( gsn_truesight, "true sight");
        ASSIGN_GSN( gsn_makemodule   , "fabricarmodulo" );
        ASSIGN_GSN( gsn_installmodule   , "instalarmodulo" );
        ASSIGN_GSN( gsn_showmodules   , "vermodulos" );
        ASSIGN_GSN( gsn_removemodule   , "desinstalarmodulo" );
	ASSIGN_GSN( gsn_makejetpack ,	"makejetpack" );
        ASSIGN_GSN( gsn_removebug   , "quitarbicho" );
        ASSIGN_GSN( gsn_spy   , "espiar" );
        ASSIGN_GSN( gsn_makecommsystem   , "fabricarcomunicador" );
        ASSIGN_GSN( gsn_commsystem   , "comunicadores" );
        ASSIGN_GSN( gsn_codecrack   , "rompercodigo" );
        ASSIGN_GSN( gsn_slicebank   , "hackearbanco" );
        ASSIGN_GSN( gsn_inquire   , "indagar" );
        ASSIGN_GSN( gsn_checkprints , "verificarhuellas" );
        ASSIGN_GSN( gsn_makedatapad   , "fabricardatapad" );
        ASSIGN_GSN( gsn_disable   , "desactivarnave" );
        ASSIGN_GSN( gsn_assignpilot   , "asignarpiloto" );
        ...
        ASSIGN_GSN( gsn_spice_refining,  "refinar especias" );
        ASSIGN_GSN( gsn_spacecombat,     "combate espacial 1" );
        ASSIGN_GSN( gsn_spacecombat2,     "combate espacial 2" );
        ASSIGN_GSN( gsn_spacecombat3,     "combate espacial 3" );
        ASSIGN_GSN( gsn_weaponsystems,   "sistemas de armas" );
        ASSIGN_GSN( gsn_bomb,	         "bombardear" );
        ASSIGN_GSN( gsn_navigation,      "navegacion" );
        ASSIGN_GSN( gsn_shipsystems,     "sistemas de naves" );
        ASSIGN_GSN( gsn_tractorbeams,    "rayotractor" );
        ASSIGN_GSN( gsn_shipmaintenance, "mantenimiento" );
        ASSIGN_GSN( gsn_scanbugs,	 "comprobarbichos" );
        ASSIGN_GSN( gsn_shipdesign,    "ship design" );
	ASSIGN_GSN( gsn_blasters,	"armas laser" );
	ASSIGN_GSN( gsn_bowcasters,	"bowcasters" );
	ASSIGN_GSN( gsn_force_pikes,	"picas de fuerza" );
	ASSIGN_GSN( gsn_lightsabers,	"lightsabers" );
	ASSIGN_GSN( gsn_vibro_blades,	"vibrohojas" );
	...
	ASSIGN_GSN( gsn_bargain,	"negociar" );
	ASSIGN_GSN( gsn_backstab,	"apunyalar" );
	ASSIGN_GSN( gsn_dualstab,	"ataquedoble" );
	ASSIGN_GSN( gsn_ambush,		"emboscar" );
	ASSIGN_GSN( gsn_bind,		"bind" );
	ASSIGN_GSN( gsn_gag,		"amordazar" );
	ASSIGN_GSN( gsn_circle,		"rodear" );
	ASSIGN_GSN( gsn_dodge,		"esquivar" );
	ASSIGN_GSN( gsn_concealment,	"esconderse" );
	ASSIGN_GSN( gsn_hide,		"ocultarse" );
	ASSIGN_GSN( gsn_peek,		"fisgar" );
	ASSIGN_GSN( gsn_pick_lock,	"forzar" );
	ASSIGN_GSN( gsn_pickshiplock  , "forzar naves" );
        ASSIGN_GSN( gsn_retreat,	"retreat" );
        ASSIGN_GSN( gsn_silent,		"silencio" );
        ASSIGN_GSN( gsn_sneak,		"disimular" );
	ASSIGN_GSN( gsn_steal,		"robar" );
	ASSIGN_GSN( gsn_gouge,		"cegar" );
	ASSIGN_GSN( gsn_poison_weapon, 	"envenenar arma" );
	ASSIGN_GSN( gsn_disarm,		"desarmar" );
	ASSIGN_GSN( gsn_enhanced_damage, "danyo incrementado" );
	ASSIGN_GSN( gsn_kick,		"patada" );
	ASSIGN_GSN( gsn_parry,		"parry" );
	ASSIGN_GSN( gsn_reflect,	"reflect" );
	ASSIGN_GSN( gsn_rescue,		"rescatar" );
	ASSIGN_GSN( gsn_repair,		"reparar" );
	ASSIGN_GSN( gsn_shiprepair,	"repararnave" );
	...
	ASSIGN_GSN( gsn_hitall,		"golpe_multiple" );
	ASSIGN_GSN( gsn_aid,		"auxiliar" );
	ASSIGN_GSN( gsn_track,		"rastrear" );
	ASSIGN_GSN( gsn_search,		"buscar" );
	ASSIGN_GSN( gsn_dig,		"cavar" );
	...
	ASSIGN_GSN( gsn_verpine,	"verpine" );
        ...
        ASSIGN_GSN( gsn_trandoshan,     "trandoshano" );
        ASSIGN_GSN( gsn_hapan,    	"hapano" );
        ASSIGN_GSN( gsn_quarren,        "quarren" );
        ASSIGN_GSN( gsn_sullustan,      "sullustano" );
	ASSIGN_GSN( gsn_falleen,	"falleen" );
	ASSIGN_GSN( gsn_barabel,	"barabel" );
	ASSIGN_GSN( gsn_yevethan,	"yevethano" );
	ASSIGN_GSN( gsn_gand,		"gand" );
	ASSIGN_GSN( gsn_coynite,	"coynite" );
        ASSIGN_GSN( gsn_duinuogwuin,    "duinuogwuin" );
	ASSIGN_GSN( gsn_droid,		"droid" );
	ASSIGN_GSN( gsn_makebeacon,	"fabricarlocalizador");
	ASSIGN_GSN( gsn_makebug,	"fabricarbicho");
	ASSIGN_GSN( gsn_plantbeacon,    "plantarlocalizador");
	ASSIGN_GSN( gsn_showbeacons,    "verlocalizadores");
	ASSIGN_GSN( gsn_checkbeacons,   "comprobarlocalizadores");
	ASSIGN_GSN( gsn_nullifybeacons, "quitarlocalizadores");
	ASSIGN_GSN( gsn_makebinders,    "makebinders");
	ASSIGN_GSN( gsn_launchers,	"launchers");
	ASSIGN_GSN( gsn_makemissile,    "makemissile");
	ASSIGN_GSN( gsn_makeempgrenade, "makeempgrenade");
	ASSIGN_GSN( gsn_makegoggles,    "fabricargafas");
	ASSIGN_GSN( gsn_barrelroll, "tonel");
	ASSIGN_GSN( gsn_juke, "picado");
...
void area_update( void )
{
	...
	if ( pArea->nplayer > 0 && pArea->age >= reset_age )
	{
		...
		strcpy( buf, "Oyes un sonido chirriante...\n\r" );
...
void free_char( CHAR_DATA *ch )
{
   ...
   while( ( fellow = ch->first_fellow ) != NULL )
   {
	...
	DISPOSE( comments->yesvotes );
	DISPOSE( comments->novotes );
	DISPOSE( comments->abstentions );
	DISPOSE( comments          );
    }
    DISPOSE( ch );
    return;
   ...
   if ( wiz->level > MAX_LEVEL - 11 )
   {
	...
	buf[0] = '\0';
      ...
      switch(ilevel)
      {
       ...
       case LEVEL_IMPLEMENTOR : towizfile( " &C        | &C|                        &W&GAdmin     &C                        | &C|&C",0 );				break;
       case LEVEL_SUB_IMPLEM  : towizfile( " &C        | &C|                        &W&GJefe de inmortales    &C                     | &C| ",0 );				break;
       case LEVEL_ASCENDANT   : towizfile( " &C        | &C|                     &W&GCoordinador de constructores  &C                     | &C| ",0 );				break;
       case LEVEL_GREATER     : towizfile( " &C        | &C|                     &W&GThe Constructor  &C                     | &C| ",0 );				break;
       case LEVEL_LESSER      : towizfile( " &C        | &C|                     &W&GThe Aprendiz  &C                    | &C| ",0 );				break;
       case LEVEL_RETIRED     : towizfile( " &C        | &C|                       &W&GThe Retirado   &C                     | &C| ",0 );				break;
	default               : towizfile( " &C        | &C|                      &W&GThe Inmortal invitado   &C                   | &C| ",0 );				break;
      }
    }
